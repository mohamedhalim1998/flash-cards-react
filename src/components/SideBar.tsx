...
const SideBar: FC<{ setId: number }> = (params) => {
  ...
  return (
    <div className="pt-8">
      ...
      <div
        className="flex flex-row content-center items-center rounded-md hover:bg-accent cursor-pointer mx-auto"
        onClick={(e) => {
          e.stopPropagation();
          navigate(`/cardset/edit/${params.setId}}`);
        }}
      >
        <svg
          className="w-12 h-12"
